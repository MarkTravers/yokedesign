...
#
#
def coilsOctagon(xRadius, yRadius, cornerRadius, thickness, zThickness, coilSegmentIndexList, gapThickness, cellsPerThickness, unvFD):
    # Create inner n-gon
    rhoCycle = [xRadius, cornerRadius, yRadius, cornerRadius]
    segmentPivotVecList = []
    segmentParallelVecList = []
...
gapThickness = 0.025
#
yokeOctagonWithPipe(xRadius, yRadius, cornerRadius, thickness, zThickness, pipeLength, pipeOR, pipeIR, cellsPerThickness=5, unvFD='')
coilsOctagon(xRadius, yRadius, cornerRadius, thickness, zThickness, [0,1,3,4,5,7], gapThickness, cellsPerThickness=5, unvFD='')
